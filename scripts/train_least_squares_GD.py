...
# test datas
def cross_validation_step_least_squares_GD(y, tx, k_indices, k, gamma, degree):
    ...
    weights, loss_train = least_squares_GD(y_train, tx_train, gamma)
...
def best_hyperparameters_least_squares_GD(y, tx, degrees, gammas, k_fold, seed=1):
    ...
    for degree in degrees:
        ...
        for gamma in gammas:
            ...
            for k in range(k_fold):
                _, _, loss_test = cross_validation_step_least_squares_GD(y, tx, k_indices, k, gamma, degree)
...
# compute the best hyperparameters for regularized optimization
def best_hyperparameters_accuracy_least_squares_GD(y, tx, degrees, gammas, k_fold, seed=1):
    ...
    for degree in degrees:
        ...
        for gamma in gammas:
            ...
            for k in range(k_fold):
                weights, _, _ = cross_validation_step_least_squares_GD(y, tx, k_indices, k, gamma, degree)
...
def train_models_least_squares_GD(y, tx, degrees, gammas, k_fold, seed=1):
    ...
    for indice_group in indices_group:
        ...
        opt_degree, opt_gamma = best_hyperparameters_accuracy_least_squares_GD(y_subset, tx_subset_standardized, degrees, gammas, k_fold, seed)
